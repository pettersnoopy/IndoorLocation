...
import ui.ChatListViewAdapter;
import ui.DrawerHScrollView;
import utils.Utils;
...
public class MessageActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(v == mSendBtn){
            ...
            if(msg.length() == 0){
                showToast("聊天内容为空");
                SoundEffect.getInstance(MessageActivity.this).play(SoundEffect.SOUND_ERR);
                return;
            }
    ...
    private void showEmoPanel(boolean show){
        ...
        if(!isUpdate && show){
            LinearLayout.LayoutParams para = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.FILL_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        ...
        public void handleMessage(Message msg) {
            ...
            switch(msg.what){
                ...
                case Task.TASK_RECV_MSG:
                    ...
                    if(sAliveCount <= 0){
                        Utils.notifyMessage(MessageActivity.this, "您有未读取消息", MessageActivity.this);
                    }
                    break;
                case Task.TASK_GET_REMOTE_STATE:
                    ...
                    if(sAliveCount <= 0){
                        if(isBTStateChanged(msg.arg1) && msg.arg1 != TaskService.BT_STAT_WAIT)
                            Utils.notifyMessage(MessageActivity.this, (String) msg.obj, MessageActivity.this);
                    }
                    break;
                case Task.TASK_SEND_MSG:
                    showToast(msg.obj.toString());
                    if(sAliveCount <= 0){
                        Utils.notifyMessage(MessageActivity.this, msg.obj.toString(), MessageActivity.this);
                    }
                    break;
            }
        }
    ...
    private void showTargetMessage(HashMap<String, Object> data){
        ...
        SoundEffect.getInstance(MessageActivity.this).play(SoundEffect.SOUND_RECV);
    }
    ...
    private void showOwnMessage(String msg){
        ...
        mAdapter2.notifyDataSetChanged();
        SoundEffect.getInstance(MessageActivity.this).play(SoundEffect.SOUND_SEND);
    }
